...
public class ERC20PaymentMonitor {
    ...
    @Value("${io.lastwill.eventscan.contract.token-address.usdt}")
    private String tokenAddressUsdt;
    ...
    protected void init() {
        ...
        addressToCurrency.put(tokenAddressUsdt.toLowerCase(), CryptoCurrency.USDT);
