...
public class WrapperTransactionNeoService implements WrapperTransactionService<Transaction> {
    ...
    public WrapperTransaction build(Transaction transaction) {
        ...
        boolean contractCreation = transaction.getScriptHash() != null && transaction.getType() == Transaction.Type.InvocationTransaction;
        ...
        if (res.isContractCreation()) res.setCreates(transaction.getScriptHash());
        return res;
    }
}
